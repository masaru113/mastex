...
テンソルは反変ベクトルと共変ベクトルの変換則を一般化したものであり、
複数の添え字を持ち、
それぞれの添え字が反変または共変のルールに従って変換される物理量。

\[
	T'^{ab...}_{pq...}
	=
	\frac{ \partial x'^{a} }{ \partial x^{i} }
	\frac{ \partial x'^{b} }{ \partial x^{j} }
	\cdots
	\frac{ \partial x'^{u} }{ \partial x^{p} }
	\frac{ \partial x'^{v} }{ \partial x^{q} }
	\cdots
	T'^{ij...}_{uv...}
\]
